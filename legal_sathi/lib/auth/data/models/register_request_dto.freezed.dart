...
@override
String toString() {
  return 'RegisterRequestDto(fullName: $fullName, email: $email, phoneNumber: $phoneNumber, password: $password, cnic: $cnic)';
}
...
class _RegisterRequestDto implements RegisterRequestDto {
  const _RegisterRequestDto({required this.fullName, required this.email, required this.phoneNumber, required this.password, this.cnic});
