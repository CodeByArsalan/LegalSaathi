...
mixin _$AuthResponseDto {
 ...
 int get userId; String get fullName; String get email; String get phoneNumber; String get role; String get accessToken; String get refreshToken; String? get cnic;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,userId,fullName,email,phoneNumber,role,accessToken,refreshToken,cnic);

@override
String toString() {
  return 'AuthResponseDto(userId: $userId, fullName: $fullName, email: $email, phoneNumber: $phoneNumber, role: $role, accessToken: $accessToken, refreshToken: $refreshToken, cnic: $cnic)';
}
...
@useResult
$Res call({
 int userId, String fullName, String email, String phoneNumber, String role, String accessToken, String refreshToken, String? cnic
});
...
/// Create a copy of AuthResponseDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? userId = null,Object? fullName = null,Object? email = null,Object? phoneNumber = null,Object? role = null,Object? accessToken = null,Object? refreshToken = null,Object? cnic = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int userId,  String fullName,  String email,  String phoneNumber,  String role,  String accessToken,  String refreshToken,  String? cnic)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthResponseDto() when $default != null:
return $default(_that.userId,_that.fullName,_that.email,_that.phoneNumber,_that.role,_that.accessToken,_that.refreshToken,_that.cnic);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int userId,  String fullName,  String email,  String phoneNumber,  String role,  String accessToken,  String refreshToken,  String? cnic)  $default,) {final _that = this;
switch (_that) {
case _AuthResponseDto():
return $default(_that.userId,_that.fullName,_that.email,_that.phoneNumber,_that.role,_that.accessToken,_that.refreshToken,_that.cnic);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int userId,  String fullName,  String email,  String phoneNumber,  String role,  String accessToken,  String refreshToken,  String? cnic)?  $default,) {final _that = this;
switch (_that) {
case _AuthResponseDto() when $default != null:
return $default(_that.userId,_that.fullName,_that.email,_that.phoneNumber,_that.role,_that.accessToken,_that.refreshToken,_that.cnic);case _:
  return null;
...
class _AuthResponseDto implements AuthResponseDto {
  const _AuthResponseDto({required this.userId, required this.fullName, required this.email, required this.phoneNumber, required this.role, required this.accessToken, required this.refreshToken, this.cnic});
...
/// Create a copy of AuthResponseDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? userId = null,Object? fullName = null,Object? email = null,Object? phoneNumber = null,Object? role = null,Object? accessToken = null,Object? refreshToken = null,Object? cnic = freezed,}) {
